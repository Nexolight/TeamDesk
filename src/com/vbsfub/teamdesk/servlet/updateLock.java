...
/**
 * Servlet implementation class updateLock
 */
@WebServlet("/updateLock")
public class updateLock extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if((String)session.getAttribute("Joined") == "yes"){
			...
			boolean check = myQuerys.updateLockNote(groupname, note_id);
			if(check == false){
