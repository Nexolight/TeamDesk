...
/**
 * Servlet implementation class updateNoteposition
 */
@WebServlet("/updateNoteposition")
public class updateNoteposition extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updateNoteposition() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if((String)session.getAttribute("Joined") == "yes"){
			...
			boolean check = myQuerys.updateNoteposition(groupname, note_id, posX, posY);
			if(check == false){
