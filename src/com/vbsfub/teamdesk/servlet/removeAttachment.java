...
/**
 * Servlet implementation class removeAttachment
 */
@WebServlet("/removeAttachment")
public class removeAttachment extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if((String)session.getAttribute("Joined") == "yes"){
			...
			int attachment_id = Integer.valueOf(request.getParameter("attachment_id"));
			boolean check = myQuerys.removeAttachment(groupname, note_id, attachment_id);
			if(check == false){
