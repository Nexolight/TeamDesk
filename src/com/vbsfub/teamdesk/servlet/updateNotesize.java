...
/**
 * Servlet implementation class updateNotesize
 */
@WebServlet("/updateNotesize")
public class updateNotesize extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updateNotesize() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if((String)session.getAttribute("Joined") == "yes"){
			...
			String size = mytools.intToXRes(asize);
			boolean check = myQuerys.updateNotesize(groupname, note_id, size);
			if(check == false){
