...
/**
 * Servlet implementation class updateNotecolors
 */
@WebServlet("/updateNotecolors")
public class updateNotecolors extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updateNotecolors() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if((String)session.getAttribute("Joined") == "yes"){
			...
			boolean check = myQuerys.updateNotecolors(groupname, note_id, color);
			if(check == false){
