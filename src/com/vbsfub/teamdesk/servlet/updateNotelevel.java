...
/**
 * Servlet implementation class updateNotelevel
 */
@WebServlet("/updateNotelevel")
public class updateNotelevel extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updateNotelevel() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if((String)session.getAttribute("Joined") == "yes"){
			...
			boolean check = myQuerys.updateNotelevel(groupname, note_id, level);
			if(check == false){
