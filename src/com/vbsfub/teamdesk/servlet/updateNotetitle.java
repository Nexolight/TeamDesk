...
/**
 * Servlet implementation class updateNotetitle
 */
@WebServlet("/updateNotetitle")
public class updateNotetitle extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if((String)session.getAttribute("Joined") == "yes"){
			...
			boolean check = myQuerys.updateNotetitle(groupname, note_id, title);
			if(check == false){
