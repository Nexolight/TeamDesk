...
/**
 * Servlet implementation class updateLastview
 */
@WebServlet("/updateLastview")
public class updateLastview extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updateLastview() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if((String)session.getAttribute("Joined") == "yes"){
			...
			boolean check = myQuerys.updateLastview(groupname, note_id);
			if(check == false){
